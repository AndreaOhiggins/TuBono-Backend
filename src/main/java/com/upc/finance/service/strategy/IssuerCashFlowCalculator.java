...
public class IssuerCashFlowCalculator implements CashFlowCalculatorStrategy{
    @Override
    ...
    public double calculate(CashFlow cashFlow, List<Double> flowList, Double cok, int paymentFrequency) {
        return calculateTCEA(cashFlow, flowList, cok, paymentFrequency);
    }

    private Double calculateTCEA(CashFlow cashFlow, List<Double> flowList, Double cok, int paymentFrequency) {
